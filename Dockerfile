...
RUN --mount=type=cache,target=/build \
	...
	wget --no-hsts --quiet \
		"https://nodejs.org/download/release/v24.13.1/node-v24.13.1-linux-$ARCH.tar.xz" \
		"https://nodejs.org/download/release/v24.13.1/SHASUMS256.txt" \
		"https://nodejs.org/download/release/v24.13.1/SHASUMS256.txt.sig" && \
